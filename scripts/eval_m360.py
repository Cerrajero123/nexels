...
def run_scene(args, scene, dnum):
    ...
    if not args.skip_training:
        ...
        common_args += " --minres 16 --maxres 256 --log_hash_table_size 20 "
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Mip-NeRF360 evaluation script parameters")
